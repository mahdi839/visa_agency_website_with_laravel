                ...
                <div class="flex justify-between h-18">
                    ...
                    <div class="flex items-center">
                        <a href="" class="flex items-center gap-2.5">
                            <img src="{{ asset('durdesh_logo.jpeg') }}" alt="Durdesh Travel Agency logo" class="w-10 h-10 rounded-lg object-contain bg-white p-1 border border-slate-100"><span class="text-xl font-bold tracking-tight text-slate-900">Durdesh Travel</span>
                        </a>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
                    ...
                    <div class="lg:col-span-1">
                        <a href="" class="flex items-center gap-2.5 mb-5">
                            <img src="{{ asset('durdesh_logo.jpeg') }}" alt="Durdesh Travel Agency logo" class="w-10 h-10 rounded-lg object-contain bg-white p-1"><span class="text-xl font-bold text-white">Durdesh Travel</span>
                        </a>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-center gap-3">
                                ...
                                <span class="text-sm">+880 1511 672172</span>
                            </li>
                            <li class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
