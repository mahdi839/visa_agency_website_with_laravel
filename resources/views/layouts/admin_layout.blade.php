    ...
    <aside x-show="sidebarOpen"
        ...
        <div class="h-[68px] flex items-center justify-between px-5 border-b border-white/[0.06]">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
                <img src="{{ asset('durdesh_logo.jpeg') }}" alt="Durdesh Travel Agency logo" class="w-8 h-8 rounded-lg object-contain bg-white p-1">
                <span class="text-base font-bold text-white tracking-tight">Durdesh Travel</span>
            </a>
            <!-- Mobile Close -->
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll py-4 px-3">
            ...
            <div class="mt-6">
                ...
                <div class="space-y-0.5">
                    ...
                    <a href="{{ route('dashboard.messages.index') }}"
                       class="{{ request()->routeIs('dashboard.messages.*') ? 'bg-emerald-600/15 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/[0.06]' }} sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150">
                        <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                        </svg>
                        Messages
                        <span class="ml-auto text-xs bg-red-500/20 text-red-400 px-2 py-0.5 rounded-full font-medium">{{ \App\Models\ThreadMessage::where('is_admin', false)->whereNull('read_at')->count() }}</span>
                    </a>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="space-y-0.5">
                    <a href="{{ route('dashboard.blog-posts.index') }}"
                       class="{{ request()->routeIs('dashboard.blog-posts.*') ? 'bg-emerald-600/15 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/[0.06]' }} sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150">
                        <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('dashboard.services.index') }}"
                       class="{{ request()->routeIs('dashboard.services.*') ? 'bg-emerald-600/15 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/[0.06]' }} sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150">
                        <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17l-5.1-5.1m0 0L11.42 4.97m-5.1 5.1H21M3 21h18" />
                        </svg>
                        Services
                    </a>
                    <a href="{{ route('dashboard.contact-submissions.index') }}"
                       class="{{ request()->routeIs('dashboard.contact-submissions.*') ? 'bg-emerald-600/15 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/[0.06]' }} sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150">
                        <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </svg>
                        Contact Messages
                        <span class="ml-auto text-xs bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded-full font-medium">{{ \App\Models\ContactSubmission::where('status', 'new')->count() }}</span>
                    </a>
